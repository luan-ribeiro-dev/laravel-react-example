...
function Dashboard({logoutUserState, dispatchLogoutUser}: Props) {
      ...
      <div className="fixed-plugin">
        ...
        <div className="card shadow-lg ">
          ...
          <div className="card-body pt-sm-3 pt-0">
            ...
            <a className="btn bg-gradient-dark w-100" href="https://www.creative-tim.com/product/soft-ui-dashboard-pro">Free Download</a>
