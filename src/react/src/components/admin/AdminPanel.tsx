            ...
            <ul className="navbar-nav">
              ...
              <li className="nav-item">
                <Link className={`nav-link ${!isDashboard && "active"}`} to="/books">
                  ...
                  <span className="nav-link-text ms-1">Books</span>
                </Link>
              </li>
            </ul>
          </div>
            ...
            <div className="container-fluid py-1 px-3">
              ...
              <div className="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                ...
                <ul className="navbar-nav justify-content-end">
                  ...
                  <li className="nav-item d-xl-none ps-5 d-flex align-items-center" onClick={() => handleSidebarOpen(!isSidebarOpen)}>
                  ...
                  <li className="nav-item ps-5 d-flex align-items-center">
                    <div className="nav-link text-body p-0" onClick={handleSignOut}>
